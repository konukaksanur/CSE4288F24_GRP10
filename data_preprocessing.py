...
import warnings
from sklearn.exceptions import ConvergenceWarning  # sklearn'den ConvergenceWarning için
import kagglehub
...
# SyntaxWarning, ConvergenceWarning ve UserWarning türündeki uyarıları engelle
